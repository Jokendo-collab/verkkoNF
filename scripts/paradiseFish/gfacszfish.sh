...
INPUT_FASTA=/data/okendojo/paradisfishProject/annotation/rmLibDB/05_full_out/reference-genome.fasta.simple_mask.soft.fasta
GFACS_OUTPUT_PFX="zebrafishANNO"
